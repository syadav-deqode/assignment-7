...
module.exports.addUser = async (body) => {
  let returnObj = { error: null, success: null, message: null, redirectUrl: null }
  ...
  if (!user) {
    ...
    returnObj = { ...returnObj, success: true, message: "New user added", redirectUrl: "/users/list/user-list" }
  } else {
...
module.exports.findOrCreateUser = async (email) => {
  ...
  returnObj = { ...returnObj, success: true, message: "List of users.", redirectUrl: "/users/list/user-list" }
